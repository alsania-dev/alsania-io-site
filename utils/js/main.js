...
// Site functionality (components are loaded by loadComponents.js)

// Initialize when DOM is ready
document.addEventListener('DOMContentLoaded', () => {
    // Initialize mobile menu (components loaded by loadComponents.js)
    initMobileMenu();
...
function initWaitlistForm() {
    ...
    waitlistForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showMessage(messageDiv, 'Thank you! You\'ll be notified when we launch.', 'success');
            waitlistForm.reset();
